...
class AmbarGerialSorgu {
  ...
  Future<String> kaydetAmbarGerial(String barkodNo) async {
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:web="http://web.ias.com">
  ...
  <soapenv:Body>
    <web:callIASService>
      ...
      <serviceid>AMBARSAYIMGERIAL</serviceid>
      <args>$parametre</args>
...
''';
    ...
    try {
      print('AMBARSAYIMGERIAL isteği gönderiliyor...');
      ...
      print('AMBARSAYIMGERIAL Cevabı: ${response.statusCode} - ${response.data}');
