...
class AmbarSayimSorgu {
  ...
  Future<String> kaydetAmbarSayim(
      String rafNo, String gozNo, String barkodNo, String adet, String sayimNo, String sicilNo) async {
...
''';
    ...
    try {
      ...
      print('AMBARSAYIM Cevabı: ${response.statusCode} - ${response.data}');
