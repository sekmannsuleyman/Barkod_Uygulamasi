...
class AdaNoKaydetSorgu {
  ...
  Future<String> kaydetAdaNo(String paletNo, String adaNo, String sicilNo, String siraNo) async {
...
''';
    ...
    try {
      ...
      print('ADANOKAYDET Cevabı: ${response.statusCode} - ${response.data}');
