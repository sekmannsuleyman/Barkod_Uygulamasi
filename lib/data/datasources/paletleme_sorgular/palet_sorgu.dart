...
'''.trim();
  ...
  Future<String> kaydetPaletlemeCubit(String kutuBarkod, String paletBarkod) async {
    await _ensureSession();

    final parametre = '0,$kutuBarkod,$paletBarkod'; // Backend formatı: 0,{kutuBarkod},{paletBarkod}
    final String envelope = '''
<?xml version="1.0" encoding="utf-8"?>
<soapenv:Envelope xmlns:soapenv="///" xmlns:web="ht.om">
  <soapenv:Header/>
  <soapenv:Body>
    <web:callIASService>
      <sessionid>$</sessionid>
...
'''.trim();
    ...
    try {
      print('Paletleme isteği gönderiliyor...');
      print('Gönderilen XML: $envelope');
      ...
      print('SSGPALETLEME Cevabı: ${response.statusCode} - ${response.data}');
