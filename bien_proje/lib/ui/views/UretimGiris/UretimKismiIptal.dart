...
class _UretimkismiiptalState extends State<Uretimkismiiptal> {
  var belgeNoController = TextEditingController();
  var paletBarkodNoController = TextEditingController();
          ...
          children: [
                ...
                children: [
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Uretimgiris(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Uretimsilme()),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
            ...
            Column(
              ...
              children: [
                ...
                TextField(
                  controller: paletBarkodNoController,
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    contentPadding: const EdgeInsets.all(10),
                  ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  context
                      .read<UretimKismiIptalCubit>()
                      .kaydetUretimKismiIptalCubit(
                        belgeNoController.text,
                        paletBarkodNoController.text,
                      );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.black,
